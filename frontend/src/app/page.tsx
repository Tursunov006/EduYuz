...
import { Users, BookOpen, CreditCard, TrendingUp, Calendar, ArrowUpRight, AlertCircle, Plus, MessageSquare } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const cards = [
    { title: "Jami O'quvchilar", value: stats.studentsCount, icon: Users, color: 'from-blue-500 to-indigo-600', href: '/students' },
    { title: 'Faol Guruhlar', value: stats.groupsCount, icon: BookOpen, color: 'from-emerald-500 to-teal-600', href: '/groups' },
    { title: 'Kurslar', value: stats.coursesCount, icon: Calendar, color: 'from-amber-500 to-orange-600', href: '/groups' },
    { title: 'Jami Tushum', value: `${stats.paymentsTotal.toLocaleString()} so'm`, icon: TrendingUp, color: 'from-violet-500 to-purple-600', href: '/payments' },
  ];
