...
import { Plus, Search, Phone, Edit2, Trash2, Download, Send, Smartphone, MessageSquare } from 'lucide-react';
...
export default function StudentsPage() {
  ...
  function exportToCSV() {
    if (students.length === 0) return alert('Yuklab olish uchun ma\'lumot yo\'q');
    const headers = ['F.I.SH', 'Telefon', 'Ota-ona telefoni', 'Balans', 'Holat'];
    ...
    link.setAttribute('download', `oquvchilar_${new Date().toISOString().split('T')[0]}.csv`);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">O‘quvchilar Bazasi</h1>
